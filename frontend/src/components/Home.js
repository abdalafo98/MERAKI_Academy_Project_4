...
export default function Home() {
  ...
  const moveToWomen = () => {
    history.push("/women");
     ...
     const pics = ["https://slimages.macys.com/is/image/McomMedia/media/022221_KIDS_CAT_PAGE_REFRESH_04_1424198.jpg?wid=750",
    ...
    <div className="containerDiv">
      ...
      >
        ...
        {pics.map((backgroundColor, index) => (
              ...
              <img  className="slide"
              key={index}
              src={backgroundColor} style={{width:"100%",height:"100%"}}></img>))}
          </div>
